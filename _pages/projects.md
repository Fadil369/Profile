...
- **`pyheart`**: Focuses on the _core_ of interoperability — message passing and standards.
- **`pybrain`**: Focuses on the _intelligence_ — NLP, Predictive Models, and Clinical Logic.
