document.addEventListener("DOMContentLoaded", () => {
  ...
  const callGemini = async (prompt) => {
    ...
    if (GEMINI_API_KEY === "YOUR_GEMINI_API_KEY") {
      ...
      if (lowerPrompt.includes("fadil"))
        return "Dr. Mohamed El Fadil is a physician and Healthcare AI Architect based in Riyadh. He founded BrainSAIT to bridge clinical medicine and AI.";
      if (lowerPrompt.includes("brainsait"))
        return "BrainSAIT is an AI ecosystem for healthcare. We do clinical decision support, NPHIES integration, and automated coding.";
      if (lowerPrompt.includes("nphies") || lowerPrompt.includes("fhir"))
        return "Dr. Fadil is an expert in HL7 FHIR R4 and NPHIES standards, helping hospitals in Saudi Arabia achieve interoperability.";
